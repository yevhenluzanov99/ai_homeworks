...
class FlattenTransform:
    """
    Трансформация для преобразования тензора изображения в одномерный вектор.
    """
...
def create_mnist_dataloaders_for_conected():
    """
...
def create_mnist_dataloaders_for_convolutional():
    """
    Create dataloaders for training and testing datasets.
