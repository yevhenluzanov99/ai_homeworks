...
mylogger = f.create_custom_logger("mylogger", "CNN_cifar.log")
metrics_path = "homework10/metrics/CNN_cifar.pkl"
model_path = "homework10/models/CNN_cifar.pth"
...
train_loader, test_loader, train_metrics, test_metrics = f.create_cifar_dataloaders()
f.set_seed(9)
