...
mylogger = f.create_custom_logger("mylogger", "1_primitiveFCNN.log")
metrics_path = "homework9/metrics/primitive_fcnn_metrics.pkl"
...
class primitiveFCNN(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        # 1st FC layer
        self.fc_input = nn.Sequential(nn.Linear(in_dim, 512), nn.Sigmoid())
        # 2nd FC layer
        self.fc_hidden = nn.Sequential(nn.Linear(512, 256), nn.Sigmoid())
        # Output FC layer
...
# Model
model = primitiveFCNN(in_dim, out_dim)
...
def train_fcnn():
    ...
    model_path = "homework9/models/primitiveFCNN.pth"
...
loaded_model = primitiveFCNN(in_dim, out_dim)
loaded_model.load_state_dict(torch.load("homework9/models/primitiveFCNN.pth"))
