...
mylogger = f.create_custom_logger("mylogger", "4_leakyFCNN_he_dropout.log")
metrics_path = "homework9/metrics/4_leakyFCNN_he_dropout_metrics.pkl"
model_path = "homework9/models/4_leakyFCNN_he_dropout.pth"
...
mylogger.info(f"learning rate: {lr}, epochs: {epochs}, dropout: 0.3")
# Model
model = leakyFCNN_he_dropout(in_dim, out_dim,0.3)
...
loaded_model = leakyFCNN_he_dropout(in_dim, out_dim, 0.3)
