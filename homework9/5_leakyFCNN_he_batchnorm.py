...
mylogger = f.create_custom_logger("mylogger", "5_leakyFCNN_he_batchnorm.log")
metrics_path = "homework9/metrics/5_leakyFCNN_he_batchnorm_metrics.pkl"
model_path = "homework9/models/5_leakyFCNN_he_batchnorm.pth"
...
# Model
model = leakyFCNN_he_batchnorm(in_dim, out_dim)
...
loaded_model = leakyFCNN_he_batchnorm(in_dim, out_dim)
