...
mylogger = f.create_custom_logger("mylogger", "3_leackyHeFCNN.log")
metrics_path = "homework9/metrics/leacky_he_fcnn_metrics.pkl"
model_path = "homework9/models/leacky_he_FCNN.pth"
...
# Model
model = leakyFCNN_he(in_dim, out_dim)
...
loaded_model = leakyFCNN_he(in_dim, out_dim)
